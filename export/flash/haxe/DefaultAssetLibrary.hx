...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("assets/data/visitor1.ttf", __ASSET__assets_data_visitor1_ttf);
		type.set ("assets/data/visitor1.ttf", AssetType.FONT);
		...
		id = "assets/data/visitor1.ttf";
		className.set (id, __ASSET__assets_data_visitor1_ttf);
		...
		openfl.text.Font.registerFont (__ASSET__assets_data_visitor1_ttf);
...
@:keep @:bind #if display private #end class __ASSET__assets_data_visitor1_ttf extends flash.text.Font { }
...
@:keep #if display private #end class __ASSET__assets_data_visitor1_ttf extends openfl.text.Font { public function new () { super (); fontName = "assets/data/visitor1.ttf"; } } 
...
#if openfl
class __ASSET__assets_data_visitor1_ttf extends openfl.text.Font { public function new () { super (); __fontPath = "assets/data/visitor1.ttf"; fontName = "Visitor TT1 BRK"; }}
...
//@:font("assets/data/visitor1.ttf") class __ASSET__assets_data_visitor1_ttf extends openfl.text.Font {}
